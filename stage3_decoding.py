...
state_dict = torch.load(paths.get_latent_policy_path(config.get().exp_name), weights_only=False)
...
idm, _ = utils.create_dynamics_models(cfg.model, state_dicts=torch.load(models_path, weights_only=False))
idm.eval()
